...
export class test {
  ...
  private mountAllPaths() {
    ...
    if (!this.swaggerDocument['paths']['/test']) {
      ...
      this.swaggerDocument['paths']['/test']['get'] = {
        summary: '',
        description: '',
        consumes: [],
        produces: [],
    ...
    this.app['get'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_LAE142K41IpxTUpX
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_LAE142K41IpxTUpX');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
